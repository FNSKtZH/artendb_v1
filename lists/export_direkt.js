function(head, req) {
	...
	// Versuch, jQuery zu referenzieren. Hat nicht funktioniert
	//var jQuery = require("lists/lib/jquery");
	...
	provides('json', function() {
		...
		while (row = getRow()) {
			...
			if (filterkriterien.length === 0 && nur_ds) {
				// hoppl_a. jetzt müssen wir trotzdem durch die Felder loopen und schauen, ob der Datensatz anzuzeigende Felder enthält
